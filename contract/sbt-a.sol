...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Errors {
     ...
     */
    constructor(string memory name_, string memory symbol_, address creator1, address creator2, address creator3) {
        _name = name_;
        _symbol = symbol_;
        _creator[creator1] = true;
        _creator[creator2] = true;
        _creator[creator3] = true;
    }
